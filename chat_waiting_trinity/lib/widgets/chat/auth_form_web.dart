...
class AuthFormWeb extends StatefulWidget {
  AuthFormWeb(this.authSubmit, this.signInWithGoogle, this.signInWithPhone,
...
class _AuthFormWebState extends State<AuthFormWeb> {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child:(FirebaseAuth.instance.currentUser != null)? Text('Succeed'): SingleChildScrollView(
        child: Container(
          child: _codeSent? Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              TextFormField(
                key: ValueKey('phone_verify'),
